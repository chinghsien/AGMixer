...
# SourceCode from https://github.com/jaygshah/Robust-Brain-Age-Prediction/blob/main/order_loss.py
...
def iorder_loss(features, y):
	...
	distance = torch.log(((distance - d_min) / d_max) + 1e-6) # Normalize to 0 ~ 1, d increase than -log(d) is smaller 
